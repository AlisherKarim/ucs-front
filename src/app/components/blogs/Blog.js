    ...
    <main className="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
      <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
        <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
          ...
          <pre>
            <code class="lang-js">{"void function x() {}"}</code>
          </pre>
          <p>
          ...
          <ol>
            ...
            <li>
              ...
              your data protection team and they can test it htmlFor real;
            </li>
            <li>
          ...
          <p>
            ...
            preparing a quick visual aid htmlFor a presentation, a low-fidelity
            prototype — like a wireframe with placeholder images and some basic
            text — would be more than enough. But if you’re going htmlFor more
          ...
          <section className="not-format">
            ...
            <article className="p-6 mb-6 text-base bg-white rounded-lg dark:bg-gray-900">
              ...
              <p>
                ...
                you! But tools are just the instruments htmlFor the UX
