    ...
    <div className="block p-6 bg-white hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
      <div className='flex justify-start items-center gap-2'>
        <div className='w-8 h-8'>
          <img className="w-8 h-8 rounded-full" src="https://www.tadpole.co.nz/wp-content/uploads/2021/02/team-1.jpg" alt="Rounded avatar" />
        ...
        <div className='flex gap-1 items-center'>
          <h5 className='font-sans font-light text-gray-900 dark:text-white'>John Doe</h5>
          <span className="text-sm text-gray-500 dark:text-gray-400">May 14</span>
        </div>
      </div>
      <div className='flex gap-1'>
        <div className='mt-2'>
          <h3 className="mb-1 text-xl font-bold tracking-tight text-gray-900 dark:text-white">Random blog title: how to get started with NextJs and Tailwind CSS</h3>
        ...
        <div className="w-36 flex items-center justify-center">
          ...
          <svg className="h-auto max-w-full text-gray-200 dark:text-gray-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
